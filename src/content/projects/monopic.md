...
- **VORA VR, 「본다빈치 발표자료」**: 가상 전시 공간 예시 3–4쪽, 편집 기능 6–9쪽, 전시 활용 제안 13–19쪽, 당시 역할 소개 21쪽. 표지는 3쪽의 전시 공간 이미지를 사용했습니다.
- **[YouTube 영상](https://youtu.be/Yk2ACH2GKaY)**

발표자료의 제품 설명과 화면을 보완 자료로 정리했으며, 개인 구현 범위는 위의 ‘담당한 개발’에 구분해 적었습니다.
